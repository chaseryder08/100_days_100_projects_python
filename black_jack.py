...
def add(user_card_1, user_card_2):
    return user_card_1 + user_card_2
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"Your cards: {user_cards}, your total sum is : {user_score}")
        print(f"Computer's first card: {computer_cards[0]}")
            
        if user_score == 0 or computer_score == 0 or user_score > 21:
            is_game_over = True
        else: 
            user_should_deal = input("Type 'y' for another card, or 'n' to pass: ")
